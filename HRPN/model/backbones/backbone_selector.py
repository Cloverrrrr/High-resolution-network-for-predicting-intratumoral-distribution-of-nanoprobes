...
from model.backbones.hrnet.hrnet_backbone import HRNetBackbone
from model.backbones.hrt.hrt_backbone import HRTBackbone
# from model.backbones.swin.swin_backbone import SwinTransformerBackbone
