...
import sys
sys.path.append('/media/aiilab/Experiments/WangShouju/HRNET/yx3/utils')
...
class HighResolutionTransformer(nn.Module):
    def __init__(self, cfg, **kwargs):
        ...
        self.bn1 = nn.BatchNorm2d(64)#nn.SyncBatchNorm(64, momentum=BN_MOMENTUM)
        self.conv2 = nn.Conv2d(64, 64, kernel_size=3, stride=2, padding=1, bias=False)
        self.bn2 = nn.BatchNorm2d(64)#nn.SyncBatchNorm(64, momentum=BN_MOMENTUM)
        self.relu = nn.ReLU(inplace=True)
    ...
    def _make_transition_layer(self, num_channels_pre_layer, num_channels_cur_layer):
        ...
        transition_layers = []
        for i in range(num_branches_cur): #用卷积改变通道数，同feature尺寸间，不改变feature大小
            if i < num_branches_pre:
                ...
                conv3x3s = []
                for j in range(i + 1 - num_branches_pre):#步长卷积用于改变feature尺寸，用于不同尺寸feature的连接
...
class HRTBackbone(object):
    ...
    def __call__(self):
        ...
        from model.backbones.hrt.hrt_config import MODEL_CONFIGS
