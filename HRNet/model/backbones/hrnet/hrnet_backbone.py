    ...
    def __init__(self, cfg, bn_type, bn_momentum, **kwargs):
        ...
        if os.environ.get("full_res_stem"):
            ...
            self.conv1 = nn.Conv2d(
                2, 64, kernel_size=3, stride=stem_stride, padding=1, bias=False
            )
            self.bn1 = ModuleHelper.BatchNorm2d(bn_type=bn_type)(
...
class HighResolutionNext(nn.Module):
    def __init__(self, cfg, bn_type, **kwargs):
        ...
        self.transition0 = self._make_transition_layer(
            [64], num_channels, bn_type=bn_type
        )
...
class HRNetBackbone(object):
    ...
    def __call__(self):
        ...
        from model.backbones.hrnet.hrnet_config import MODEL_CONFIGS
