...
class HRNet_W48(nn.Module):
    ...
    def __init__(self, configer):
        ...
        # extra added layers
        in_channels = 270  # 48 + 96 + 192 + 384    # 18 + 36 + 72 + 144
...
class HRNet_W48_OCR(nn.Module):
    def __init__(self, configer):
        ...
        from model.spatial_ocr_block import SpatialGather_Module

        self.ocr_gather_head = SpatialGather_Module(self.num_classes)
        from model.spatial_ocr_block import SpatialOCR_Module
